  ...
  <div class="more-sb" id="moreSidebar" role="dialog" aria-label="Menu" aria-hidden="true">
    ...
    <div class="more-body">
      ...
      <div class="acc-menu-group">
	    <p class="acc-label">Tema</p>
		<div class="theme-switch-wrap">
    
		<div class="theme-switch" id="themeSwitch" role="radiogroup" aria-label="Tema da interface">
          <button class="theme-opt" data-theme-choice="light" role="radio" aria-checked="true" title="Tema claro">
      ...
      <div class="acc-menu-group" style="gap:10px">
		...
		<button class="btn-acc-option" onclick="buttonLink('/')">
          <div class="btn-content">
            <span class="btn-title"><i class="fa-solid fa-house-chimney"></i> Início</span>
            <p class="btn-txt">Volte para a página inicial rapidamente em um clique.</p>
          </div>
          <span class="btn-arrow">&gt;</span>
        </button>
    ...
    <div class="acc-body">
      <button class="acc-profile-summary" onclick="buttonLink('/settings')">
        <div class="acc-avatar-large">
		  <img style="display:none" id="accSidebarAvatar" src="" alt="Avatar">
          <i class="fa-solid fa-user" id="accSidebarIcon"></i>
        </div>
