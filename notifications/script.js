...
document.addEventListener('keydown', e => { if (e.key === 'Escape') { closeCart(); closeSettings(); } });
window.addEventListener('resize', () => { const active = document.querySelector('.ftab.active'); if (active) movePill(active); });
